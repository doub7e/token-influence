#!/usr/bin/env bash
# Test: allsel + hessian + NO unit normalization at bsz=128.
# Same as run_4b_infl_bsz128.sh Config A but token_unit_norm=False.
set -xeuo pipefail
...
NAME="infl-bsz128-allsel-no-unitnorm"
DST="$BASE_DIR/$NAME"
