...
exp_name='Archer2.0-Qwen3-1.7B-Base-Ent015-Clip01'
...
max_response_length=$((1024 * 4))  # 4096; same as R1-1.5B baseline
...
low_entropy_clip_ratio_high=0.1
...
python -m dapo.main_dapo \
    ...
    actor_rollout_ref.actor.entropy_coeff=0.015 \
