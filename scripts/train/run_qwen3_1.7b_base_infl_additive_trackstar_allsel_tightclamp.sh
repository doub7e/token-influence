...
# Tight clamp ablation: lambda=0.01, clamp=[0.75, 1.25], sign flip (v2 style)
set -xeuo pipefail
...
exp_name='Archer2.0-Qwen3-1.7B-Base-TrackStar-AllSel-TightClamp-L001-v2'
...
python -m dapo.main_dapo \
    ...
    +trainer.influence_token_weight.additive_lambda=0.01 \
    +trainer.influence_token_weight.additive_clamp_min=0.75 \
    +trainer.influence_token_weight.additive_clamp_max=1.25 \
