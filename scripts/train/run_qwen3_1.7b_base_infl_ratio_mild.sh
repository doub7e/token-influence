...
exp_name='Archer2.0-Qwen3-1.7B-Base-Ratio-Mild-v2'
...
python -m dapo.main_dapo \
    ...
    +trainer.influence_token_weight.mode=ratio \
    +trainer.influence_token_weight.apply_epochs='[0,1]' \
    +trainer.influence_token_weight.ratio_clamp_min=-1.0 \
    +trainer.influence_token_weight.ratio_clamp_max=3.0 \
    +trainer.influence_token_weight.ratio_snr_threshold=0.3 \
