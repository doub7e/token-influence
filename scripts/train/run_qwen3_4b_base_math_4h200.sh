...
exp_name='Archer2.0-Qwen3-4B-Base-Math-4H200'
...
max_response_length=$((1024 * 1))  # 1024; short for fast iteration on base model
...
micro_batch_size_per_gpu=4  # 4B model is larger → reduce micro-batch
