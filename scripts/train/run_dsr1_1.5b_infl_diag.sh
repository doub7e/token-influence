#!/usr/bin/env bash
# Diagnostic influence trace run — DeepSeek-R1-Distill-Qwen-1.5B
# 1 step only, no weighting, no eval.
# Usage: bash run_dsr1_1.5b_infl_diag.sh \
...
exp_name='Archer2.0-DSR1-1.5B-Diag-Default'
...
python -m dapo.main_dapo \
    ...
    +trainer.influence_trace.force_gpu_compute=False \
