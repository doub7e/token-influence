...
exp_name='Archer2.0-R1-1.5B-InflWeight-Softmax'
...
python -m dapo.main_dapo \
    ...
    +trainer.influence_token_weight.mode=softmax \
    +trainer.influence_token_weight.normalize=zscore \
    +trainer.influence_token_weight.apply_epochs='[1,2]' \
    +trainer.influence_token_weight.softmax_temperature=10.0 \
    +trainer.influence_token_weight.weight_clamp_min=0.1 \
    +trainer.influence_token_weight.weight_clamp_max=5.0 \
