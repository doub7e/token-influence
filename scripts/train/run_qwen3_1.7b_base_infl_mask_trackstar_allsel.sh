#!/usr/bin/env bash
# Qwen3-1.7B-Base + TrackStar mask mode (all_selected scope)
# mask mode: zero out advantage for wrong-direction tokens based on influence sign
set -xeuo pipefail
...
exp_name='Archer2.0-Qwen3-1.7B-Base-TrackStar-Mask-AllSel-v6'
...
python -m dapo.main_dapo \
    ...
    +trainer.influence_token_weight.mode=mask \
