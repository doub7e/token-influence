...
exp_name='Archer2.0-Qwen3-1.7B-Base-Ratio-Wide-v2'
...
python -m dapo.main_dapo \
    ...
    +trainer.influence_token_weight.ratio_clamp_min=-2.0 \
    +trainer.influence_token_weight.ratio_clamp_max=5.0 \
    +trainer.influence_token_weight.ratio_snr_threshold=0.1 \
