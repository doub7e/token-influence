...
exp_name='Qwen3-4B-SoftmaxCredit-T8-clamp08-allsel'
wandb_name='Qwen3-4B-SoftmaxCredit-T8-clamp08-allsel'
...
python -m dapo.main_dapo \
    ...
    +trainer.influence_token_weight.softmax_temperature=8.0 \
    +trainer.influence_token_weight.weight_clamp_min=0.8 \
    +trainer.influence_token_weight.weight_clamp_max=1.2 \
