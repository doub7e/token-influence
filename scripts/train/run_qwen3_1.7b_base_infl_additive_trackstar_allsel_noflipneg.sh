#!/usr/bin/env bash
# Qwen3-1.7B-Base + TrackStar token influence weighting (all_selected scope)
...
exp_name='Archer2.0-Qwen3-1.7B-Base-TrackStar-AllSel-NoFlipNeg-L003-v4'
...
python -m dapo.main_dapo \
    ...
    +trainer.influence_token_weight.additive_clamp_min=0.0 \
    +trainer.influence_token_weight.additive_clamp_max=2.0 \
    +trainer.influence_token_weight.adv_target=advantage \
    +trainer.influence_token_weight.apply_to=noflip_neg \
