#!/usr/bin/env bash
# Qwen3-1.7B-Base + Random mask ablation (all_selected scope)
# mask_random: same fraction masked as mask mode but randomly selected
set -xeuo pipefail
...
exp_name='Archer2.0-Qwen3-1.7B-Base-TrackStar-MaskRandom-AllSel-v6'
...
python -m dapo.main_dapo \
    ...
    +trainer.influence_token_weight.mode=mask_random \
