...
exp_name='Archer2.0-Qwen3-1.7B-Base-TrackStar-Credit-AllSel-L002-v5d'
...
python -m dapo.main_dapo \
    ...
    +trainer.influence_token_weight.additive_lambda=0.02 \
    +trainer.influence_token_weight.additive_clamp_min=-0.1 \
    +trainer.influence_token_weight.additive_clamp_max=0.1 \
